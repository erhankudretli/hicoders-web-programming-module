...
if (hizmetZamani >= 5) {
    ...
    if (aracRengi == "siyah" || aracRengi == "kirmizi") {
        if (aracMarkasi == "BMW") {
            ...
            console.log("Aracinizi kabul ETMIYORUZ"); // renk siyah yada kirmizi degilse döngüsü
        }
    } else {
        console.log("Aracinizi kabul ETMIYORUZ");  // hizmet zamani 5 yildan büyük degilse döngüsü
    }
}